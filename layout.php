...
<script type="text/javascript" src="__PUBLICAPP__/js/jquery.min.js"></script>
...
<!-- <div class="layout">
  <div class="container height-big">
    ...
    <div class="hidden-l float-right padding fadein-right  text-right"><span class="text-small">TAGS:</span> 
        {tag:{table=(tags) field=(name,url) order=(hits desc,id desc) limit=(3)}}
...
<div class="layout bg-write fixed-top " style="opacity: 1">
<div class="container">
<div class="navbar navbar-big bg-inverse radius">
    <!-- JiaThis Button BEGIN -->
  <div class="jiathis_style_24x24 share2" >
    <a class="jiathis_button_weixin" style="padding: 0;"></a>
    
    <a class="jiathis_button_tsina" style="padding: 0;"></a>
    <a class="jiathis_button_qzone" style="padding: 0;"></a>
  </div>
<!-- JiaThis Button END -->
...
<!-- JiaThis Button END -->
    ...
    <a href="{url()}"><img src="__PUBLICAPP__/images/logo.png" style="width: 36px;height: 36px" class="img-responsive" /></a>
  </div>  
  <div class="navbar-body nav-navicon" id="navbar-bg1">
    <ul class="nav nav-inline nav-menu nav-big" data-offset-spy="90" style="text-align: center;">
   ...
   <!--  <div class="navbar-text navbar-right">
          {if !$memberoff}
             {if !empty($auth)}
               <a href="{url('member/index/index')}" class="button bg-blue">
               {if $auth['nickname']}{$auth['nickname']}{else}会员中心{/if}</a> 
               <a class="button bg-blue" href="{url('member/index/logout')}">退出</a>
              {else}
                <a class="button bg-blue" href="{url('member/index/login')}">登录</a> 
                <a class="button bg-blue" href="{url('member/index/regist')}">注册</a>
...
<!-- fadein-bottom属性是动画 --> 
<div class="bg-write margin-top fixed-bottom " style="width: 100%;">
<div class="container padding-big-top padding-big-bottom ">
 <!--  <div class="padding-top padding-big-bottom hidden-l text-white  clearfix link">
  ...
  <div class="text-center text-black fadein-bottom">
    版权所有:浙江远东工业开发有限公司
  &nbsp;&nbsp;&nbsp;&nbsp;{$icp}<!-- 地址:{$address} <br>
     联系电话:{$telephone}&nbsp;&nbsp;&nbsp;&nbsp;公司油箱：{$email}<br>
     {$icp}&nbsp;&nbsp;&nbsp;&nbsp; --><!-- <a class="text-white" href="{url('index/map')}">网站地图</a> -->
  </div>
</div>
</div>
<!--[if lt IE 9]>
