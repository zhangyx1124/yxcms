$(function(){
	...
	$(window).resize(function(){
		...
		$(".carousel .item").css("width",itemWidth+ "px");
		$(".carousel").css("width",itemWidth*num + "px");
	...
	$('.banner').each(function(){
		var e=$(this);
		var clone=e.find(".carousel .item").first().clone(true);
		e.find(".carousel").append(clone);
		...
		/*var itemWidth=Math.ceil($(window).width()/items);*/
		...
		var carousel=function(){
			i++;
			if(i>page){i=2;e.find(".carousel").css("left","0");}
		...
		if(pointer!=0 && page>1){
			...
			lefter.click(function(){
				i--;
				if(i<1){i=page;e.find(".carousel").css("left",-itemWidth*(page-1)+"px");}
				$showbanner(e,i,items,num);
			});
			righter.click(function(){
				...
				if(i>page){i=2;
					e.find(".carousel").stop(true, true);/*修复点击过快时的bug*/
					e.find(".carousel").css("left","0");
	...
	$showbanner=function(e,i,items,num){
		...
		if(i==num){
			...
			e.find(".pointer li").eq(0).addClass("active");
			/*console.log(e.find(".pointer li").eq(0).className());*/
		}else{
			e.find(".pointer li").removeClass("active");
